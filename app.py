...
def main():
    ...
    html1 = """
    <div style="text-align:center; color: #FF5733; text-shadow: 2px 2px 4px #000000;">
      <h1> Path Finder  </h1>
      <p></p>
    </div>
    """
    ...
    with col1:
        st.image("./assets/mew2.jpg")

    with col2:
        st.image("./assets/mew.jpg") 

    with col3:
        st.image("./assets/mew3.jpg")

    html2 = """
    <div style="text-align:center; color: #FF5733; text-shadow: 2px 2px 4px #000000;">
      <h2>A Career Advisor For You!</h2>
    </div>
    """
    ...
    'How would you rate your logical skills on a scale of 0 to 10?', 0,10,1)
    ...
    'How many hackathons have you participated in?',0,10,1)
    st.write(hackathons)
    ...
    'Do you have a capability for self-learning? ',
    ('Yes', 'No')
    )

    Extra_courses_did = st.selectbox(
    'Have you taken any extra courses to enhance your skills? ',
    ('Yes', 'No')
    )

    Taken_inputs_from_seniors_or_elders = st.selectbox(
    'Have you sought serous advice from seniors or elders? ',
    ('Yes', 'No')
    )
